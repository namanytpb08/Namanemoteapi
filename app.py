...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14048157618')  # <-- FIXED BOT UID

    Uid, Pw = '4326988645', '476725969CD77D2AB563C4EE7C25DDC1EE59D3BDD77EA2B8342326265562135A'
    ...
    os.system('clear')
    print(render('NAMAN', colors=['white', 'green'], align='center'))
